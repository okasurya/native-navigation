...
public let LOAD_DELAY: Int64 = Int64(1.2 * Double(NSEC_PER_SEC))
...
extension UIViewController {
  ...
  func internalPresentReactViewController(
    ...
    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + Double(LOAD_DELAY) / Double(NSEC_PER_SEC)) {
...
extension UINavigationController {
  ...
  public func pushReactViewController(_ viewController: ReactViewControllerProtocol, animated: Bool) {
    pushReactViewController(viewController, animated: animated, delay: LOAD_DELAY, makeTransition: nil)
  }

  public func pushReactViewController(
    _ viewController: ReactViewControllerProtocol,
    animated: Bool,
    delay: Int64 = LOAD_DELAY,
    makeTransition: (() -> ReactSharedElementTransition)?
  ) {
